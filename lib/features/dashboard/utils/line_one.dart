...
class LineOne extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    Path path_3 = Path();
    path_3.moveTo(size.width * 0.7000000, size.height * 0.5221843);
    path_3.cubicTo(
    ...
    path_3.cubicTo(size.width * 0.2492308, size.height * 0.06484642,
    ...
    paint3Fill.color = const Color(0xff00B7E9).withOpacity(1.0);
