...
class PartialBox extends CustomPainter {
    @override
...
Path path_0 = Path();
    ...
    path_0.cubicTo(size.width*0.6700000,size.height*0.6400000,size.width*0.6850000,size.height*0.6550000,size.width*0.7000000,size.height*0.6550000);
    path_0.cubicTo(size.width*0.7150000,size.height*0.6550000,size.width*0.7300000,size.height*0.6400000,size.width*0.7300000,size.height*0.6250000);
